...
envsubst  '${PUBLIC_URL},${REACT_APP_API_URL},${NEW_OPENIMIS_HOST},${ROOT_MOBILEAPI},${REDIRECT_TAIL},${DATA_UPLOAD_MAX_MEMORY_SIZE},${OPENSEARCH_PROXY_HOST},${OPENSEARCH_PROXY_ROOT}' < /conf/openimis.conf > /etc/nginx/conf.d/openIMIS.conf
